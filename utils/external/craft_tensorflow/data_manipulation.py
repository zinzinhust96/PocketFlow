...
def resize(image, character=None, side=768):
	...
	if character is not None: # work with none-char given
...
def add_affinity(image, bbox_1, bbox_2):
	...
	# Check the relative position of the two boxes
	is_horizontal = True
	connected_line = center_2 - center_1 #the line connects the two center points
	if connected_line[1] > connected_line[0]:
		# print('this is a vertical case')
		is_horizontal = False
